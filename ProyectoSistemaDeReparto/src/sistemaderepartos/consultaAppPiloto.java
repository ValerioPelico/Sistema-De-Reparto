...
import sistemaderepartos.menuPiloto;
/**
 *
 * @author dairy
 */
public class consultaAppPiloto extends javax.swing.JFrame {

    /**
     * Creates new form consultaAppPiloto
     */
    public consultaAppPiloto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jlt_piloto = new javax.swing.JList<>();
        ...
        cbx_piloto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ordenes Efectuadas por el Encargado", "Ordenes Incompletas" }));
        ...
        jScrollPane1.setViewportView(jlt_piloto);
    ...
    private void btn_regresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_regresarActionPerformed
        menuPiloto volver = new menuPiloto();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultaAppPiloto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultaAppPiloto().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<String> jlt_piloto;
